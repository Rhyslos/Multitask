...
async function getServerChanges(db, userID, lastSync) {
    ...
    const users = await db.all(`
        SELECT DISTINCT u.id, u.email, u.displayName, u.firstName, u.lastName, u.countryIso, u.phoneNumber, u.gender, u.skillset, u.privacySettings, u.cursorColor, u.updatedAt, u.isDeleted 
        FROM users u
